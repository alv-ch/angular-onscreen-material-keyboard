...
export class MatKeyboardComponent implements OnInit {
    ...
    private _isDebug: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);

    private _inputInstance$: BehaviorSubject<ElementRef | null> = new BehaviorSubject<ElementRef | null>(null);
