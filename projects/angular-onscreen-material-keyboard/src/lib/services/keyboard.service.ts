...
export class MatKeyboardService {
    ...
    openFromComponent(layoutOrLocale: string, config: MatKeyboardConfig): MatKeyboardRef<MatKeyboardComponent> {
        ...
        keyboardRef.instance.darkTheme = config.darkTheme ?? false;
        keyboardRef.instance.isDebug = config.isDebug ?? false;
     ...
     */
    open(layoutOrLocale: string = this._defaultLocale, config: Partial<MatKeyboardConfig> = {}): MatKeyboardRef<MatKeyboardComponent> {
